...
class StripeService {
  ...
  static String secret = 'sk_live_XbRVtyTRlTmDwfbu5xBBIEMJ00INJEa00B';
  ...
  static init() {
    StripePayment.setOptions(
      StripeOptions(
        publishableKey: "pk_live_E6HDLSbKUktyAEaCOi2LNfz000XYYycXNo",
        merchantId: "Test",
        androidPayMode: 'test'
      )
    );
  ...
  static Future<StripeTransactionResponse> payWithNewCard({String amount, String currency}) async {
    try {
      ...
      print('entramos al payvianewcar');
      var paymentIntent = await StripeService.createPaymentIntent(
        amount,
        currency
      );
